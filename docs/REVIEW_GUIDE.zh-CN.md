...
[English](REVIEW_GUIDE.md) | **简体中文** · [文档索引](README.md)

本文供维护者和社区审阅者使用。审核结论应能由另一个人根据公开信息复现。

## 一、门槛检查

六项全部为“是”才可正式收录；极少数经维护者批准的有记录例外除外，且必须在项目目录和审核记录中明确标注：
...
确认 `added_at` 是维护者当地正式批准收录的日期，而不是帖子发布日期、仓库创建日期或 Grok 的发现日期。自动校验允许一天的 UTC 时区偏差，避免处于 CI 运行器东西两侧的贡献者在午夜被误判。媒体资源需链接原始来源；不复制没有授权的素材。
